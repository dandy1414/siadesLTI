<section>
    ...
    <div class="container pt-5">
        <img class="img-thumbnail" width="500px" height="500px" style="display: block; margin-left: auto; margin-right: auto;" src="<?= base_url(); ?>assets/upload/<?php echo $row->gambar; ?>">
