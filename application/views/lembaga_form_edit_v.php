				...
				<div class="panel-body">
					...
					<form method="post" action="<?php echo site_url('Lembaga/edit'); ?>">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="in_nama_lembaga" required="" value="<?php echo $row->nama_lembaga; ?>">
						</div>
						<div>
							<label for="usr">Detail lembaga</label>
							<textarea class="ckeditor" id="isi" name="isi" style="height:800px;"><?php echo $row->detail_lembaga; ?></textarea>
						</div>
