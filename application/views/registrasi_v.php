...
<html lang="en">
<head>
	<title>Login Registrasi Admin Lauwba</title>
	<meta charset="UTF-8">
			...
			<div class="container-login100" style="background-image: url('<?php echo base_url();?>login/images/bg-01.jpg');">
				<div class="container">
					...
					<div class="mt-3 mb-3" style="margin:0px;display:flex;justify-content:center;width:100%">
						<h2 style="color:white">Account Lauwbas Register </h2>
					</div>
					<div style="width:100%;display:flex;justify-content:center;">
						<div>
							<form class="login100-form validate-form p-b-33 p-t-5" action="<?php echo site_url('Account/insert');?>" method="post">
								<div class="wrap-input100 validate-input" data-validate = "">
									<input class="input100" type="text" name="in_email" placeholder="Email">
                                ...
                                <div class="wrap-input100 validate-input" data-validate="">
									<input class="input100" type="password" name="in_jenis_kelamin" placeholder="Jenis Kelamin">
									<span class="focus-input100" data-placeholder="&#xe80f;"></span>
								</div>
                                <div class="wrap-input100 validate-input" data-validate="">
									<input class="input100" type="password" name="in_alamat" placeholder="Alamat">
									<span class="focus-input100" data-placeholder="&#xe80f;"></span>
								</div>
