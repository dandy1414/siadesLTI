				...
				<div class="panel-body">
					...
					<form method="post" action="<?php echo site_url('Programdesa/edit'); ?>"
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="in_lokasi" required=""
								value="<?php echo $row->lokasi; ?>">
						</div>

						<div class="form-group">
							<label for="usr">Pekerjaan:</label>
							<input type="text" class="form-control" name="in_pekerjaan" required=""
								value="<?php echo $row->pekerjaan; ?>">
						</div>

						<div class="form-group">
							<label for="usr">Keterangan:</label>
							<input type="text" class="form-control" name="in_keterangan" required=""
